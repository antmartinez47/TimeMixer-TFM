python3 train_timemixer.py \
    ...
    --features M --save_dir ./checkpoints/baseline/ETTh1_96_96 \
...
python3 train_timemixer.py \
    --model TimeMixer \
    --data ETTh1 --root_path ./dataset/ETT-small/ --data_path ETTh1.csv \
    --features M --save_dir ./checkpoints/baseline/ETTh1_96_192 \
...
python3 train_timemixer.py \
    --model TimeMixer \
    --data ETTh1 --root_path ./dataset/ETT-small/ --data_path ETTh1.csv \
    --features M --save_dir ./checkpoints/baseline/ETTh1_96_336 \
...
python3 train_timemixer.py \
    --model TimeMixer \
    --data ETTh1 --root_path ./dataset/ETT-small/ --data_path ETTh1.csv \
    --features M --save_dir ./checkpoints/baseline/ETTh1_96_720 \
