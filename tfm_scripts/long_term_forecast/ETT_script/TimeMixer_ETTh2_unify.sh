python3 train_timemixer.py \
    ...
    --features M --save_dir ./checkpoints/baseline/ETTh2_96_96 \
...
python3 train_timemixer.py \
    --model TimeMixer \
    --data ETTh2 --root_path ./dataset/ETT-small/ --data_path ETTh2.csv \
    --features M --save_dir ./checkpoints/baseline/ETTh2_96_192 \
...
python3 train_timemixer.py \
    --model TimeMixer \
    --data ETTh2 --root_path ./dataset/ETT-small/ --data_path ETTh2.csv \
    --features M --save_dir ./checkpoints/baseline/ETTh2_96_336 \
...
python3 train_timemixer.py \
    --model TimeMixer \
    --data ETTh2 --root_path ./dataset/ETT-small/ --data_path ETTh2.csv \
    --features M --save_dir ./checkpoints/baseline/ETTh2_96_720 \
