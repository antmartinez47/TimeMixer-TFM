...
python3 train_timemixer.py \
    ...
    --features M --save_dir ./checkpoints/baseline/ETTm2_96_96 \
...
python3 train_timemixer.py \
    --model TimeMixer \
    --data ETTm2 --root_path ./dataset/ETT-small/ --data_path ETTm2.csv \
    --features M --save_dir ./checkpoints/baseline/ETTm2_96_192 \
...
python3 train_timemixer.py \
    --model TimeMixer \
    --data ETTm2 --root_path ./dataset/ETT-small/ --data_path ETTm2.csv \
    --features M --save_dir ./checkpoints/baseline/ETTm2_96_336 \
...
python3 train_timemixer.py \
    --model TimeMixer \
    --data ETTm2 --root_path ./dataset/ETT-small/ --data_path ETTm2.csv \
    --features M --save_dir ./checkpoints/baseline/ETTm2_96_720 \
