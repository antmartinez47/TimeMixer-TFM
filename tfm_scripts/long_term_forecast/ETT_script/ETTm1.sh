...
python3 train_timemixer.py \
    ...
    --features M --save_dir ./checkpoints/baseline/reproduction/ETTm1_96_96 \
...
python3 train_timemixer.py \
    --model TimeMixer \
    --data ETTm1 --root_path ./dataset/ETT-small/ --data_path ETTm1.csv \
    --features M --save_dir ./checkpoints/baseline/reproduction/ETTm1_96_192 \
...
python3 train_timemixer.py \
    --model TimeMixer \
    --data ETTm1 --root_path ./dataset/ETT-small/ --data_path ETTm1.csv \
    --features M --save_dir ./checkpoints/baseline/reproduction/ETTm1_96_336 \
...
python3 train_timemixer.py \
    --model TimeMixer \
    --data ETTm1 --root_path ./dataset/ETT-small/ --data_path ETTm1.csv \
    --features M --save_dir ./checkpoints/baseline/reproduction/ETTm1_96_720 \
