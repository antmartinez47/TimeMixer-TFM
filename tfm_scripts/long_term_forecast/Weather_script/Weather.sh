python3 train_timemixer.py \
    ...
    --features M --save_dir ./checkpoints/baseline/reproduction/weather_96_96 \
...
python3 train_timemixer.py \
    --model TimeMixer \
    --data custom --root_path ./dataset/weather/ --data_path weather.csv \
    --features M --save_dir ./checkpoints/baseline/reproduction/weather_96_192 \
...
python3 train_timemixer.py \
    --model TimeMixer \
    --data custom --root_path ./dataset/weather/ --data_path weather.csv \
    --features M --save_dir ./checkpoints/baseline/reproduction/weather_96_336 \
...
python3 train_timemixer.py \
    --model TimeMixer \
    --data custom --root_path ./dataset/weather/ --data_path weather.csv \
    --features M --save_dir ./checkpoints/baseline/reproduction/weather_96_720 \
